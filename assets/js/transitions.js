  ...
  finish: function() {
    ...
    Promise.all([pro1, pro2, pro3, pro4]).then(values => {
      ...
      var contactWidth = $(".contact").width(),
        ...
        testimonialsWidth = $(".testimonials").width(),
      ...
      $(this.oldContainer)
        ...
        .animate(
          {
            left: "+=" + testimonialsWidth + "px",
            top: "-=" + testimonialsHeight + "px"
          },
          400
        );
      $(this.oldContainer)
  ...
  fadeIn: function() {
    Promise.all([this._newContainerPromise]).then(() => {
      ...
      if (this.newContainer.baseURI === window.location.origin + '/') {
        ...
        $(".testimonials-border").css({ width: "100%" });
        $(".algorithms-border").css({ width: "100%" });
        var contactXPos = $(".contact").position().left,
          contactYPos = $(".contact").position().top,
          testimonialsXPos = $(".testimonials").position().left,
          testimonialsYPos = $(".testimonials").position().top,
